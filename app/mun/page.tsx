  ...
  return (
    <>
      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        ...
        <section className="relative overflow-hidden rounded-2xl mb-16">
          ...
          >
            <div className="max-w-2xl text-white">
              <span className="inline-block px-4 py-1.5 rounded-full bg-[#d9a74e]/20 text-[#d9a74e] text-xs font-bold tracking-[0.2em] uppercase mb-6 backdrop-blur-sm border border-[#d9a74e]/30">
                Excellence in Diplomacy
              </span>
              <h1 className="text-5xl md:text-7xl font-bold leading-[1.1] mb-6">Model United Nations</h1>
              ...
              <div className="flex flex-wrap gap-4">
                <button className="bg-white text-primary px-8 py-4 rounded-xl font-bold hover:bg-gray-100 transition-all flex items-center gap-2 group">
                  Register for Next MUN
                  <span className="material-symbols-outlined text-sm group-hover:translate-x-1 transition-transform">
                    arrow_forward
                  </span>
                </button>
                <button className="bg-white/10 backdrop-blur-md text-white border border-white/30 px-8 py-4 rounded-xl font-bold hover:bg-white/20 transition-all">
                  View 2024 Schedule
                </button>
              </div>
            </div>
        ...
        {/* Final CTA */}
        <section className="text-center py-20 px-6 border-t border-gray-100 dark:border-gray-800">
